...
public class CamCap extends javax.swing.JFrame {
    ...
    CascadeClassifier cascadeDetector;  // Objeto reconocedor de imagenes
    CascadeClassifier eyeDetector;   // Objeto para reconocer ojos

    MatOfRect cascadeDetections;   // Matriz donde se alojarán las caras detectadas
    ...
    String cascadeFile = "cascade.xml";  // Archivo referencia para reconocimiento de rostros
    ...
    class DaemonThread implements Runnable {
        ...
        public void run() {
            ...
            cascadeDetector = new CascadeClassifier(base_path + cascadeFile); // Se crea un objeto CascadeClassifier que reconocera caras
            cascadeDetections = new MatOfRect(); // Se inicializa el objeto donde se guardaran las caras detectadas
                ...
                while (runnable) {
                    if (webSource.grab()) {
                        try {
                            ...
                            cascadeDetector.detectMultiScale(frame, cascadeDetections); // Se buscan las caras dentro de la imagen y se guardan en cascadeDetections
                            ...
                            for (Rect rect : cascadeDetections.toArray()) {
                                ...
                                cara = frame.submat(cascadeDetections.toArray()[i]);
